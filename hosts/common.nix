...
in
{
  inherit (constants) defaultLocale emails extraHosts extraLocaleSettings hostRecords name nix nix-be nix-cuda ports pubkeys sysctl_opts templates timeZone tz;
