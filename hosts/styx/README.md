...
$(nix build --no-link --print-out-paths --extra-experimental-features nix-command --extra-experimental-features flakes ~/cfg#hmx.styx)/bin/switch
```
...
This file defines the OS configuration for the `styx` machine.
