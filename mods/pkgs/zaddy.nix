...
rec {
  _zaddy =
    let
      builtins = {
        ...
        caddy-security = { name = "github.com/greenpau/caddy-security"; version = "v1.1.41"; };
        ...
        googleclouddns = { name = "github.com/caddy-dns/googleclouddns"; version = "v1.1.0"; };
        porkbun = { name = "github.com/caddy-dns/porkbun"; version = "v0.2.1"; };
        hetzner = { name = "github.com/caddy-dns/hetzner"; version = "v0.0.1"; };
        route53 = { name = "github.com/caddy-dns/route53"; version = "v1.6.0-beta.2"; };
        ...
        # s3 stuff
        s3-proxy = { name = "github.com/jpetrucciani/caddy-s3-proxy"; version = "6af2251f1d84defc1ff2371a8b5ffe6c524cd0e9"; };
        ...
        # gcs stuff
        gcs-proxy = { name = "github.com/jpetrucciani/caddy-gcs-proxy"; version = "fe266eea8ab4cfa3e10bdb96060ec5cae5bdfc7c"; };

        # utils
        ## jacobi's plugins
        caddy-hax = { name = "github.com/jpetrucciani/caddy-hax"; version = "v0.0.3"; };
        caddy-troll = { name = "github.com/jpetrucciani/caddy-troll"; version = "v0.0.2"; };
        ## other
        ...
        geolocation = { name = "github.com/jpetrucciani/caddy-maxmind-geolocation"; version = "8140d8a0de8f1263b4dc0bd52195ec1d3c6302df"; };
    ...
    let
      ...
      zaddy = prev.caddy.override {
        buildGo125Module = args:
          let _args = args { inherit version; }; in final.buildGo126Module (_args // {
  ...
  zaddy = _zaddy {
    ...
    vendorHash = "sha256-Y5BGt9UyENd5hvkk1JrHZpYsPKI8QyEwqIbJPuGEApM=";
  };
