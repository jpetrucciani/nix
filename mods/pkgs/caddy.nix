...
rec {
  _zaddy =
    let
      builtins = {
        ...
        caddy-security = { name = "github.com/greenpau/caddy-security"; version = "v1.1.16"; };
  ...
  zaddy = _zaddy {
    ...
    vendorSha256 = "sha256-gkxIxetpHby3FUOIB1HChF01bXyDgJLdTTo/NGyzwjY=";
  };
  ...
  zaddy-browser = _zaddy {
    ...
    vendorSha256 = "sha256-fGiHAaXrzKr6TaOct734wot3W0KhLj1w6g0Y4zMk4sw=";
  };
}
