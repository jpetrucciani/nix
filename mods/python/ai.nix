...
rec {
  llama-cpp-python =
    let
      ...
      llama-cpp-pin = pkgs.fetchFromGitHub {
        owner = "ggerganov";
        repo = "llama.cpp";
        rev = "254a7a7a5ff4c874ff8488f1f5cbdd7e9c89d682";
    ...
    buildPythonPackage rec {
      ...
      src = pkgs.fetchFromGitHub {
        ...
        hash = "sha256-M5etx/7j4+lhnANYnWhLQ/7C5dpHFg0ET19IQ2TcUWY=";
      };
  ...
  langchainplus-sdk = buildPythonPackage
    rec {
      ...
      src = fetchPypi {
        ...
        inherit version;
        hash = "sha256-u/3FTGTfXKQzQGirLXuJ06iU8xOxKFk5tMRTL+pi7rc=";
      };
  ...
  langchain = buildPythonPackage rec {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      repo = pname;
      rev = "refs/tags/v${version}";
      hash = "sha256-FnjYDn5MUTwwG0UPIgr9bHpXJ9bR45wGSJqPfHeQ7KU=";
    };
  ...
  llama-index = buildPythonPackage rec {
    ...
    src = prev.pkgs.fetchFromGitHub {
      ...
      repo = "llama_index";
      rev = "refs/tags/v${version}";
      hash = "sha256-lP1n0MaV3nUBs6rXQIWlZMHtvwHu3zBiWLZ0d2wmDjg=";
    };
