...
rec {
  llama-cpp-python =
    let
      ...
      llama-cpp-pin = pkgs.fetchFromGitHub {
        owner = "ggerganov";
        repo = "llama.cpp";
        rev = "8596af427722775f0df4a7c90b9af067ba90d4ef";
        hash = "sha256-Tht5GhDa2Y3jxGwt9CeEUQAZdV7JBysYaEBz1TK5Xg4=";
      };
    in
    buildPythonPackage rec {
      ...
      src = pkgs.fetchFromGitHub {
        ...
        hash = "sha256-LsTICGgH9NF0m1Nh0SOiHs+xixuh1PQ1mmhzFuDOS/4=";
      };
  ...
  langchainplus-sdk = buildPythonPackage
    rec {
      ...
      src = fetchPypi {
        ...
        inherit version;
        hash = "sha256-5QZ5MJox2VJvRnqhPU28+6DcAKKVzqcv/MmXKGXsrBs=";
      };
  ...
  langchain = buildPythonPackage rec {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      repo = pname;
      rev = "refs/tags/v${version}";
      hash = "sha256-aZABPwLyK/QTPo8J1IaOj5AWwW/C0lWAoy3qXo/Wnsw=";
    };
  ...
  llama-index = buildPythonPackage rec {
    ...
    src = prev.pkgs.fetchFromGitHub {
      ...
      repo = "llama_index";
      rev = "refs/tags/v${version}";
      hash = "sha256-Ao6lZYpVUaHZuN3bZ5Cv1fyLwQSWBIPDtCTBspV8Tqs=";
    };
