...
rec {
  langsmith = buildPythonPackage rec {
    ...
    src = fetchPypi {
      ...
      hash = "sha256-P9RMWL1Ty5Nmrz3hKcfxG2lHkU8btZilhSQN8OLFZus=";
    };
  ...
  langchain-community = buildPythonPackage rec {
    ...
    src = fetchPypi {
      ...
      inherit version;
      hash = "sha256-t962P9ggXVS1HPixcC3hXR2neYf4Rlw1axWKZa3/N4w=";
    };
  ...
  langchain-core = buildPythonPackage rec {
    ...
    src = fetchPypi {
      ...
      inherit version;
      hash = "sha256-9wAThonJAU4j08KXlqiS3M9/KkKQHLiBdnGCPhokckw=";
    };
  ...
  langchain = buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-or7yAFzFFJSkuo7zWCUU5s3XdFAbHbiZMwxsmefEhac=";
    };
  ...
  llama-index = buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "llama_index";
      rev = "refs/tags/v${version}";
      hash = "sha256-Vm2AqATklCw818CloNNJvNmx9nHaKBk+3xCiD33CjPg=";
    };
