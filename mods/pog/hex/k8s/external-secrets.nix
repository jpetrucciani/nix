...
let
  ...
  external-secrets = rec {
    ...
    version = rec {
      ...
      latest = v0-10-2;
      v0-10-2 = _v "0.10.2" "0zc34xadrps5xngmanhq1nivgfzx1kgcip7immqzd1knda83bid3"; # 2024-08-28
      v0-10-0 = _v "0.10.0" "1l6vsg95spjzrvcr4z0l9h1lcq4bsxj00s6lz7i6cglj4c9vr2sw"; # 2024-08-03
